...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{
        \item{\textbf{Optical Design \& Analysis}{: Compact systems, Holographic optics, Diffractive optics, Illumination, System architecture, End-to-end modeling, Tolerancing, Radiometry, Wavefront propagation, Interferometry, Stray light}}\\
        \item{\textbf{Programming \& Tools}{: Python, PyTorch, Custom ray tracing, Zemax OpticStudio (ZOS) API, RCWA/GSolver, ENZ, Git, FDTD, Code V, FRED, MATLAB, LabVIEW, SolidWorks, Autodesk  Inventor}} \\
        \item{\textbf{Laboratory \& Prototyping}{: Prototype development, Manufacturing partnerships, Cleanroom operations, Optical AIT, Fizeau/LUPI interferometry, CMM metrology, Spectroradiometry, Rapid iteration, Cryogenic \& vacuum testing} }\\
    }
\end{itemize}
