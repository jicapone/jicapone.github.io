...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{
        \item\begin{minipage}[t]{\linewidth}
            \textbf{Design \& System Architecture}: \hangindent=25pt \hangafter=1 \raggedright Optical system architecture; Compact imaging systems; Holographic and diffractive optics; Freeform optics; Illumination design; Requirements flowdown and validation; Verification planning; Performance budgets
        \end{minipage}
        \item\begin{minipage}[t]{\linewidth}
        ...
        \end{minipage}
        \item\begin{minipage}[t]{\linewidth}
            \textbf{Hardware Implementation}: \hangindent=25pt \hangafter=1 \raggedright Custom test setups; Data ananlysis; Specifications; Drawings; Vendor technical interface; Prototyping; Alignment, integration, \& test (AIT); Fizeau and LUPI interferometry; Spectroradiometry; Coordinate measuring machines; Cryogenic and vacuum testing; Cleanroom operations; Experimental nuclear physics
        \end{minipage}
        \item\begin{minipage}[t]{\linewidth}
...
\resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Supports Optics Branch leadership (100+ personnel) with capability assessments, technical oversight, and project staffing for a team of 16 optical scientists and engineers, including 10 Ph.D.-level staff}
        \resumeItem{Organizes and delivers technical talks to promote cross-project learning and accelerate knowledge transfer across missions}
        \resumeItem{Coordinates peer reviews and updated group work instruction to strengthen engineering rigor, foster collaboration, and improve quality control}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {NASA Goddard Space Flight Center}{Greenbelt, MD, USA}
      \resumeItemListStart
        \resumeItem{Reduced CCRS Vision System camera count from 13 to 7 within two months of onboarding by scripting a custom spatial-resolution analysis}
        ...
        \resumeItem{Validated CCRS vision requirements using synthetic imagery and machine learning to assess compliance}
    ...
    \resumeSubheading 
      ...
      \resumeItemListStart
        \resumeItem{Led design and analysis of €4M Spectrograph system for first-light integral field spectrograph on the 39-meter ELT}
        ...
        \resumeItem{Delivered realistic as-built MC analysis with custom Python library + ZOS API to simulate manufactured optics, including mid-spatial errors, and AIT}
        \resumeItem{Modeled, procured, and tested custom VPH gratings; developed spectroradiometer; collaborated with KOSI, Wasatch, INAF, and Syzygy}
