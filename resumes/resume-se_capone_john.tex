...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{
        \item\begin{minipage}[t]{\linewidth}
            \textbf{Optical Design}: \hangindent=25pt \hangafter=1 \raggedright System architecture; Requirements flowdown and validation; Verification planning; Performance budgets; Compact imaging systems; Holographic and diffractive optics; Freeform surfaces; Illumination design
        \end{minipage}
        \item\begin{minipage}[t]{\linewidth}
            \textbf{Optical Modeling}: \hangindent=25pt \hangafter=1 \raggedright High-fidelity ray tracing; Radiometry; End-to-end modeling; Tolerancing; Monte Carlo (MC) analysis; Wavefront propagation; Differential wavefront sensing (DWS), Extended Nijboer-Zernike (ENZ) analysis; Rigorous Coupled-Wave Analysis (RCWA); Interferometry; Stray light; Finite-Difference Time-Domain (FDTD)
        \end{minipage}
        \item\begin{minipage}[t]{\linewidth}
...
\resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Coordinated activities with Branch leadership (100+ personnel) aligning team of 16 engineers with mission needs}
        \resumeItem{Organized and delivered technical talks to promote knowledge transfer across projects}
        \resumeItem{Updated group work instruction to strengthen engineering rigor, foster collaboration, and improve quality control}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Led cryogenic optical design and modeling of RIMAS, a compact near-IR imaging spectrometer on the 4.3-m DCT}
        ...
        \resumeItem{Modeled, procured, tested VPH gratings and ZnSe grisms; coordinated with Wasatch and LLNL to meet specifications}
...
\begin{itemize}[leftmargin=0.15in, label={}, noitemsep, topsep=0pt]
    \small{
        \item{\textbf{Road to Mission Success Workshop}{, one week course at NASA (2022)}}
        \item{\textbf{Introduction to Project Management}{ one day course at University of Oxford (2019)}}
        \item{\textbf{Advanced Optical Systems Design}{, one week Zemax OpticStudio training (2018)}}
        \item{\textbf{Illumination \& Stray Light}{, one week Zemax OpticStudio training (2018)}}
        \item{\textbf{Systems Engineering Fast Track}{, one week course at University of Oxford (2017)}}
    }
\end{itemize}
